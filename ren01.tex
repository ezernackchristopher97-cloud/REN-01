...
\section{Experimental Plan}\label{appendix:experimental_plan}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{2cm}\textbf{REN-02 Molecular Structure}\\\textit{Alzheimer's Disease Variant}\\\vspace{1cm}\\Components: Modified cholinergic modulator core + PEG3 linker + CB2 selective ligand + Amyloid targeting peptide domain\\Molecular weight: $\sim$1400-1500 Da\vspace{2cm}}}
\caption{\textbf{REN-02 Molecular Structure (Alzheimer's Disease).} The REN-02 conjugate is designed for cortical memory entropy destabilization. Features shorter PEG3 linker for enhanced cortical penetration and amyloid targeting peptide for localization to affected regions.}
\label{fig:ren02_structure_appendix}
\end{figure}

\begin{figure}[H]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{2cm}\textbf{REN-03 Molecular Structure}\\\textit{Schizophrenia Variant}\\\vspace{1cm}\\Components: D2/5-HT2A modulator core + PEG2 linker + CB2 selective ligand + Cortical targeting peptide\\Molecular weight: $\sim$1300-1400 Da\vspace{2cm}}}
\caption{\textbf{REN-03 Molecular Structure (Schizophrenia).} The REN-03 conjugate targets cortical thalamic recursive chaos. Features compact PEG2 linker and D2/5-HT2A modulator core for balanced dopamine serotonin regulation in prefrontal circuits.}
\label{fig:ren03_structure_appendix}
\end{figure}

\begin{figure}[H]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{2cm}\textbf{REN-04 Molecular Structure}\\\textit{ALS Variant}\\\vspace{1cm}\\Components: Motor neuron protective core + PEG4 linker + CB2 selective ligand + SOD1 targeting peptide domain\\Molecular weight: $\sim$1450-1550 Da\vspace{2cm}}}
\caption{\textbf{REN-04 Molecular Structure (Amyotrophic Lateral Sclerosis).} The REN-04 conjugate is designed for motor neuron entropy degradation. Features PEG4 linker for spinal cord penetration and SOD1 targeting peptide for localization to affected motor neurons.}
\label{fig:ren04_structure_appendix}
\end{figure}

\begin{figure}[H]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{2cm}\textbf{REN-05 Molecular Structure}\\\textit{Epilepsy Variant}\\\vspace{1cm}\\Components: GABA modulator core + PEG2 linker (alternate topology) + CB2 selective ligand + Oscillation stabilizing peptide\\Molecular weight: $\sim$1350-1450 Da\vspace{2cm}}}
\caption{\textbf{REN-05 Molecular Structure (Epilepsy).} The REN-05 conjugate targets unstable neural oscillations and feedback loops. Features alternate topology PEG2 linker and GABA modulator core for regime stabilization of hyperexcitable circuits.}
