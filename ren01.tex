...
\begin{figure}[H]
 ...
 \caption{Algebraic chain evolution in (q$_1$, q$_2$, q$_3$) space. Each scenario follows a distinct path determined by its context-dependent multiplication order. The healthy state shows tight clustering (low entropy), degenerative shows drift (increasing entropic load), and REN-01 shows regime restoration toward a low-entropy state.}
 \label{fig:alg_chain}
\end{figure}
